...
let Tooltip = class Tooltip extends Component {
    ...
    getScalingFactor(element) {
        if (element) {
            const xScalingFactor = element.getBoundingClientRect().width / element.offsetWidth;
            const yScalingFactor = element.getBoundingClientRect().height / element.offsetHeight;
